...
\\ And \myvec{I & I & 0 \\ 0 & I & I \\ I & 0 & I \\ } as T 
...
\begin{center}
 \myvec{A  \\ B \\ C \\ } &= 2 $\frac{1}{2}\ $\myvec{1 & 1 & -1 \\ -1 & 1 & 1 \\ 1 & -1 & 1 \\ } \myvec{P  \\ Q \\ R}  
\end{center}
\begin{align}
\myvec{A  \\ B \\ C \\ } &= \myvec{P & Q & -R \\ -P & Q & R \\ P & -Q & R \\ }\\
\myvec{A  \\ B \\ C \\ } &= \myvec{ $\myvec{4 \\ 5} \\ $\myvec{2 \\ 3} \\ $\myvec{6 \\ 9} }    
\end{align}
