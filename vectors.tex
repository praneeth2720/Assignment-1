...
$\vec{x}_1 +$\vec{x}_2 =6\\
$\vec{x}_2 +$\vec{x}_3 =8\\
$\vec{x}_1 +$\vec{x}_3 =10\\
\end{align}

\\solving these three equations we get $\vec{x}_1 = 4,$\vec{x}_2 =2,$\vec{x}_3 =6.
\\ Now equating 2^{ND}\\ row of matrices in each side we get\   

\begin{align}
$\vec{y}_1 +$\vec{Y}_2 =8\\
$\vec{y}_2 +$\vec{Y}_3=12\\
$\vec{y}_1 +$\vec{Y}_3=14\\
\end{align}
\\solving these three equations we get $\vec{y}_1 =5,$\vec{y}_2 =3,$\vec{y}_3 =9.
